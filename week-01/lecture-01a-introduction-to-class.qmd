...
![](img/GitHub_Invertocat_White.png){fig-alt="Image of GitHub logo. A cartoon cat in a white circle." fig-align="center"}

We will be using GitHub for version control, so let's make our accounts. We will learn GitHub next lecture.

- Make a GitHub account with your CI email <https://github.com/>
- Let me know your username <https://forms.gle/DEiwBWsjf9vH9uMp9>
