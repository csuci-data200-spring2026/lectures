...
$R^2$ is the percent of variation on $Y$ explained by model.
...
model_4_eval <- glance(penguins_model_4)
```


Model 1 explains `r 100 * round(model_1_eval$r.squared, 2)`% of the variation in Bill Depth.

Model 4 explains `r 100 * round(model_4_eval$r.squared, 2)`% of the variation in Bill Depth.
