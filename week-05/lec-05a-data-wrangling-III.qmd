...
Factors are an R storage type for categorical data. By storing a variable as a factor:

- R knows what possibilities to expect (aka the **levels**)
- R saves an ordering for the levels
