...
**Question 5**\newline
Which planets would be the data frame printed by this code?
```{r}
#| eval: false
planets |>
...
**Question 7**\newline
How many planets would be the data frame printed by this code?
```{r}
#| eval: false
planets |>
  filter(length_of_day != "negative" | ring_system == FALSE)
```
